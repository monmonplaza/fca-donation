...
const AdmModalArchiveDesignation = ({ onClickClose }) => {
    return (
        <>
            <div className="modal" >
                <div className="modal__main">
                    <div className="modal__header">
                        <h3>Archive Designation</h3>
                    ...
                    <div className="modal__body message__prompt">
                        <p>This action will archive the user from the list and become inactive.
                        </p>
                    </div>
...
export default AdmModalArchiveDesignation
